defmodule LoinWeb.CoreComponents do
  @moduledoc """
  ...
  def error(assigns) do
    ~H"""
    <p class="phx-no-feedback:hidden mt-3 flex gap-3 text-sm text-rose-600">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LoinWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LoinWeb.Gettext, "errors", msg, opts)
    end
  end
