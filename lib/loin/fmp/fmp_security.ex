defmodule Loin.FMP.FMPSecurity do
  ...
  def changeset(fmp_security, attrs) do
    fmp_security
    |> cast(attrs, [:description, :exchange, :exchange_short_name, :full_time_employees, :image, :in_dow_jones, :in_nasdaq, :in_sp500, :industry, :is_etf, :market_cap, :name, :sector, :symbol, :website])
    |> validate_required([:description, :exchange, :exchange_short_name, :in_dow_jones, :in_nasdaq, :in_sp500, :industry, :is_etf, :market_cap, :name, :sector, :symbol])
