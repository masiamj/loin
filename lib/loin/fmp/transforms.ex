defmodule Loin.FMP.Transforms do
  ...
  def profile(%{"Symbol" => symbol} = security) when is_map(security) do
    %{
      address: Map.get(security, "address"),
      beta: Map.get(security, "beta") |> string_to_number(:float),
      ...
      cusip: Map.get(security, "cusip"),
      dcf: Map.get(security, "dcf") |> string_to_number(:float),
      dcf_difference: Map.get(security, "dcfDiff") |> string_to_number(:float),
      ...
      is_adr: Map.get(security, "isAdr") |> is_truthy(),
      is_etf: Map.get(security, "isEtf") |> is_truthy(),
      is_fund: Map.get(security, "isFund") |> is_truthy(),
      isin: Map.get(security, "isin"),
  ...
  defp is_truthy(value), do: value == "true" || value == true || value == "TRUE"
