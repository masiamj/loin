defmodule Loin.FMPTest do
  ...
  describe "fmp_securities" do
    ...
    @invalid_attrs %{description: nil, exchange: nil, exchange_short_name: nil, full_time_employees: nil, image: nil, in_dow_jones: nil, in_nasdaq: nil, in_sp500: nil, industry: nil, is_etf: nil, market_cap: nil, name: nil, sector: nil, symbol: nil, website: nil}
    ...
    test "create_fmp_security/1 with valid data creates a fmp_security" do
      valid_attrs = %{description: "some description", exchange: "some exchange", exchange_short_name: "some exchange_short_name", full_time_employees: 42, image: "some image", in_dow_jones: true, in_nasdaq: true, in_sp500: true, industry: "some industry", is_etf: true, market_cap: 42, name: "some name", sector: "some sector", symbol: "some symbol", website: "some website"}
    ...
    test "update_fmp_security/2 with valid data updates the fmp_security" do
      ...
      assert {:ok, %FMPSecurity{} = fmp_security} = FMP.update_fmp_security(fmp_security, update_attrs)
