defmodule LoinWeb.UserAuthTest do
  use LoinWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Loin.Accounts
  alias LoinWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LoinWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LoinWeb.Endpoint.subscribe(live_socket_id)
