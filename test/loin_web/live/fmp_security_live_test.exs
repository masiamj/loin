defmodule LoinWeb.FMPSecurityLiveTest do
  ...
  @create_attrs %{description: "some description", exchange: "some exchange", exchange_short_name: "some exchange_short_name", full_time_employees: 42, image: "some image", in_dow_jones: true, in_nasdaq: true, in_sp500: true, industry: "some industry", is_etf: true, market_cap: 42, name: "some name", sector: "some sector", symbol: "some symbol", website: "some website"}
  @update_attrs %{description: "some updated description", exchange: "some updated exchange", exchange_short_name: "some updated exchange_short_name", full_time_employees: 43, image: "some updated image", in_dow_jones: false, in_nasdaq: false, in_sp500: false, industry: "some updated industry", is_etf: false, market_cap: 43, name: "some updated name", sector: "some updated sector", symbol: "some updated symbol", website: "some updated website"}
  @invalid_attrs %{description: nil, exchange: nil, exchange_short_name: nil, full_time_employees: nil, image: nil, in_dow_jones: false, in_nasdaq: false, in_sp500: false, industry: nil, is_etf: false, market_cap: nil, name: nil, sector: nil, symbol: nil, website: nil}
  ...
  describe "Index" do
    ...
    test "updates fmp_security in listing", %{conn: conn, fmp_security: fmp_security} do
      ...
      assert index_live |> element("#fmp_securities-#{fmp_security.id} a", "Edit") |> render_click() =~
               "Edit Fmp security"
    ...
    test "deletes fmp_security in listing", %{conn: conn, fmp_security: fmp_security} do
      ...
      assert index_live |> element("#fmp_securities-#{fmp_security.id} a", "Delete") |> render_click()
